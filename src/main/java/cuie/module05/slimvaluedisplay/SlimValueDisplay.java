...
public class SlimValueDisplay extends Region {
    ...
    private void setupValueChangedListeners() {
        ...
        valueProperty()   .addListener((observable, oldValue, newValue) -> startValueAnimation());
        ...
        // updateUI wenn sich animatedValue ändert
    ...
    private void startValueAnimation() {
        ...
        // code hier
        // die animation verändert den animatedValue
        timeline.getKeyFrames().setAll(new KeyFrame(Duration.millis(1000),
                new KeyValue(animatedValue, getValue())
        ));
    ...
    private void updateUI() {
        bar.setVisible(true);
        bar.setLength(getAngle(animatedValue.getValue()));
    }
