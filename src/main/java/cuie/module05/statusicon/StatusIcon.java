...
public class StatusIcon extends Region {
    ...
    private void initializeParts() {
        ...
        line1.setMouseTransparent(true); // reagiert nicht auf mausklicks
    ...
    private void updateUI(){
        // was immer getan werden muss wenn sich der Status aendert

        timeline.stop();

        Status status = getStatus(); // merke mir aktuellen status

        KeyFrame kf = new KeyFrame(Duration.millis(500),
                new KeyValue(line1.startXProperty(), status.line1Start.getX()),
                new KeyValue(line1.startYProperty(), status.line1Start.getY()),
                new KeyValue(line1.endXProperty(), status.line1End.getX()),
                new KeyValue(line1.endYProperty(), status.line1End.getY()),

                new KeyValue(line2.startXProperty(), status.line2Start.getX()),
                new KeyValue(line2.startYProperty(), status.line2Start.getY()),
                new KeyValue(line2.endXProperty(), status.line2End.getX()),
                new KeyValue(line2.endYProperty(), status.line2End.getY()),

                new KeyValue(line3.startXProperty(), status.line3Start.getX()),
                new KeyValue(line3.startYProperty(), status.line3Start.getY()),
                new KeyValue(line3.endXProperty(), status.line3End.getX()),
                new KeyValue(line3.endYProperty(), status.line3End.getY())
        );
