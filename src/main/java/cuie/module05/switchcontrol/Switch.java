...
public class Switch extends Region {
    ...
    public Switch() {
        ...
        layoutParts();
        initializeAnimations(); // neue Hilfsmethode Animationen
        setupEventHandlers();
    ...
    private void initializeAnimations() {
        ...
        TranslateTransition onTranslation = new TranslateTransition(Duration.millis(1000), thumb);
        onTranslation.setFromX(0);
        onTranslation.setToX(16.0);
        onAnimation = new ParallelTransition(onTranslation);

        TranslateTransition offTranslation = new TranslateTransition(Duration.millis(1000), thumb);
        offTranslation.setFromX(16.0);
        offTranslation.setToX(0);
        offAnimation = new ParallelTransition(offTranslation);
    }
    ...
    private void updateUI(){
        // alles zuerst abschalten,
        // sicherstellen, dass animationen nicht doppelt laufen
        onAnimation.stop();
        offAnimation.stop();
